  ...
  <div class="rate-component">
    <a-list itemLayout="horizontal">
      <a-list-item>
        ...
        <a-switch checkedChildren="开" unCheckedChildren="关" @change="changeVal('allowHalf')" v-model="initData.allowHalf"/>
      </a-list-item>
      ...
      <a-list-item>
        ...
        <a-switch checkedChildren="开" unCheckedChildren="关" @change="changeVal('allowClear')" v-model="initData.allowClear"/>
      </a-list-item>
      ...
      <a-list-item>
        ...
        <a-slider v-model="initData.value" :max="initData.count" :step="0.5" style="width:100%" @change="changeVal('value')" />
      </a-list-item>
      ...
      <a-list-item>
        ...
        <a-slider v-model="initData.count" :max="10" style="width:100%" @change="changeVal('count')" />
      </a-list-item>
      ...
      <a-list-item>
        ...
        <a-switch checkedChildren="开" unCheckedChildren="关" @change="changeVal('disabled')" v-model="initData.disabled"/>
      </a-list-item>
    </a-list>
  </div>
</template>
