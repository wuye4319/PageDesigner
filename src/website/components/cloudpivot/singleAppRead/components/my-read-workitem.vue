    ...
    <div class="table-box" v-if="isShowTableBox">
      ...
      <div class="table" ref="table">
        <a-table
          ...
          :columns="columns">
          <!-- 序号 -->
          <span slot="indexTitle" class="resize resize-first">{{ $t('cloudpivot.flowCenter.pc.orderNumber') }}</span>
          ...
          <template slot="instanceName" slot-scope="text,record">
            <span
              ...
              class="fake-btn text-ellipsis"></span>
          </template>
          ...
          <template slot="workflowName" slot-scope="text,record">
            ...
            <span
              v-else
              :class="record.isRead ? 'gray text-ellipsis' : 'text-ellipsis'"
              :title="record.name_i18n[$i18n.locale]">{{ record.name_i18n[$i18n.locale] }}</span>
          </template>
          ...
          <!-- 接收时间 -->
          <span slot="receiveTimeTitle" class="resize">{{ $t('cloudpivot.flowCenter.pc.reciveTime') }}</span>
...
import filterCard from './filter-card/filter-card.vue';
