...
import MyReadWorkItem from './components/my-read-workitem.vue';

@Component({
  name: 'singleAppRead-Component',
  components: {
    Readed: MyReadWorkItem
  }
})
export default class singleAppReadComponent extends Vue {
...
.app-readed {
  ...
  /deep/ .table-box {
    ...
    .table {
      max-height: calc(100vh - 60px - 70px - 60px);
