    ...
    <div class="table-box" v-if="isShowTableBox">
      ...
      <div class="table" ref="table">
        <a-table
          ...
          <!-- 流程名称 -->
          <span slot="instanceTitle" class="resize">{{ $t('cloudpivot.flowCenter.pc.flowName') }}</span>
          ...
          <!-- 审批节点 -->
          <span slot="activityNameTitle" class="resize">{{ $t('cloudpivot.flowCenter.pc.approvalNode') }}</span>
          ...
          <!-- 处理结果 -->
          <span slot="approvalTxtTitle" class="resize">{{ $t('cloudpivot.flowCenter.pc.resolveRzt') }}</span>
          <template slot="approvalTxt" slot-scope="text">
            <span class="text-ellipsis">{{ text }}</span>
          </template>

          <!-- 处理时间 -->
          <span slot="finishTimeTitle" class="resize">{{ $t('cloudpivot.flowCenter.pc.resolveTime') }}</span>
          ...
          <!-- 流程状态 -->
          <span slot="workflowInstanceStateTitle" class="resize">{{ $t('cloudpivot.flowCenter.pc.flowStatus') }}</span>
...
import * as WorkflowCenterTypes from '../../common/typings/workflow-center';
