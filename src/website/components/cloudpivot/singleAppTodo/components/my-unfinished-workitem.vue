    ...
    <div class="table-box" v-if="isShowTableBox">
      ...
      <div class="table" ref="table">
        ...
        >
          ...
          >{{ $t('cloudpivot.flowCenter.pc.orderNumber') }}</span>
          ...
          <template slot="stayTime" slot-scope="text,record">
            ...
            <span class="deadline-tip">
              ...
              <img
                ...
                class="overtime-icon"
                src="../assets/warning01.png"
              >
              <img
                v-else-if="record.workItemTimeoutStatus === 'ORANGE'"
                class="overtime-icon"
                src="../assets/warning02.png"
              >
            </span>
          </template>
...
import { workflowCenterApi, workflowCenter as workflowCenterParams } from '@cloudpivot_v2/api';

import * as WorkflowCenterNS from '../../common/typings/workflow-center';

import * as WorkflowCenterHelper from '../../common/helper/helper';
...
@Component({
  name: 'singleAppTodoList-component',
  components: {
    CommonDrawer,
...
export default class singleAppTodoListComponent extends mixins(WorkItemMixin) {
  /**
   * 单应用集成属性,集成时不显示title
   */
  @Prop({
