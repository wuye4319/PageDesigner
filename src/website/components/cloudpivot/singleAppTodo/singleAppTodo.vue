...
import MyUnFinishedWorkItem from './components/my-unfinished-workitem.vue';

@Component({
  name: 'singleAppTodo-component',
  components: {
    ToDo: MyUnFinishedWorkItem
  }
})
export default class singleAppTodoComponent extends Vue {
