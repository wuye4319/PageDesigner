  ...
  <div class="progress-ant-component">
    <a-list itemLayout="horizontal">
      ...
      <a-list-item>
        ...
        <a-slider v-model="initData.percent" style="width:100%" @change="changeVal('percent')" />
      </a-list-item>
      ...
      <a-list-item>
        ...
        <a-radio-group @change="changeVal('status')" v-model="initData.status" class="type-radio">
      ...
      <a-list-item>
        ...
        <a-switch checkedChildren="开" unCheckedChildren="关" @change="changeVal('showInfo')" v-model="initData.showInfo"/>
      </a-list-item>
      ...
      <a-list-item>
        ...
        <a-radio-group @change="changeVal('strokeLinecap')" v-model="initData.strokeLinecap" class="type-radio">
      ...
      <a-list-item v-show="initData.type !== 'dashboard'">
        ...
        <a-slider v-model="initData.strokeWidth" :max="initData.type === 'circle'? 100 : 500" style="width:100%" @change="changeVal('strokeWidth')" />
      </a-list-item>
      ...
      <a-list-item v-show="initData.type === 'circle'">
        ...
        <a-slider v-model="initData.width" :max="500" style="width:100%" @change="changeVal('width')" />
      </a-list-item>
      ...
      <a-list-item v-show="initData.type === 'circle'">
        ...
        <a-slider v-model="initData.gapDegree" :max="360" style="width:100%" @change="changeVal('gapDegree')" />
      </a-list-item>
      ...
      <a-list-item v-show="initData.type === 'circle'">
        ...
        <a-radio-group @change="changeVal('gapPosition')" v-model="initData.gapPosition" class="type-radio">
