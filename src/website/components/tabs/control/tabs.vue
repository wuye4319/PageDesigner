  ...
  <div class="tabs-component">
    <a-list itemLayout="horizontal">
      <a-list-item>
        ...
        <a-switch checkedChildren="开" unCheckedChildren="关" @change="changeVal('animated')" v-model="initData.animated"/>
      </a-list-item>
      ...
      <a-list-item v-show="initData.type==='editable-card'">
        ...
        <a-switch checkedChildren="开" unCheckedChildren="关" @change="changeVal('hideAdd')" v-model="initData.hideAdd"/>
      </a-list-item>
      ...
      <a-list-item>
        ...
        <a-radio-group @change="changeVal('tabPosition')" v-model="initData.tabPosition" class="type-radio">
      ...
      <a-list-item>
        ...
        <a-slider v-model="initData.tabBarGutter" :max="100" style="width:100%" @change="changeVal('tabBarGutter')" />
      </a-list-item>
    </a-list>
  </div>
</template>
